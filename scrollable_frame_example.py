...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.scrollable_checkbox_frame = ScrollableCheckBoxFrame(master=self, width=200, command=self.checkbox_frame_event, label_text_color = "red",
        ...
        self.scrollable_radiobutton_frame = ScrollableRadiobuttonFrame(master=self, width=500, command=self.radiobutton_frame_event,
                                                                       ...
                                                                       label_text="ScrollableRadiobuttonFrame", label_font=('Nirmala UI', 10))
        ...
        self.scrollable_radiobutton_frame.configure(label_text_color = "green")
        ...
        for i in range(20):  # add items with images
            self.scrollable_label_button_frame.add_item(f"image and item {i}", image=customtkinter.CTkImage(Image.open(os.path.join(current_dir, "chat_light.png"))))
        self.scrollable_label_button_frame.remove_item("image and item 5")
